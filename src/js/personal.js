...
$(document).on("click", ".personal_area_arrow", function(){
    $(".personal_area__mobile_list_wrapper").toggleClass("open");
    $(".area_svg").toggleClass("active");
})
...
$(document).on('change','#fileinput',function () {
  ...
  $(document).on("change", "#check_input", function(){
    $(".personal_area_check_input").removeClass("active");
