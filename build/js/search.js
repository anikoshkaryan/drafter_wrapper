const swiper = new Swiper('#first_swiper_container', {
  ...
  const swiper_four = new Swiper('#four_swiper_container', {
    // Optional parameters
    direction: 'horizontal',
    loop: true,
    slidesPerView: 2,
  ...
  const swiper_seven = new Swiper('#seven_swiper_container', {
    // Optional parameters
    direction: 'horizontal',
    loop: true,
    slidesPerView: 2,
  ...
  $(document).on("click",".read_more_btn", function(){
    ...
    if($(this).parent().hasClass('open') ) {
        ...
        $(this).parent(".description_info").find(".show_more").removeClass("open");

    } else {
        $(this).parent(".description_info").find(".dots").hide();
        $(this).html('Свернуть')
        $(this).parent(".description_info").find(".show_more").addClass('open');
...
$(document).on("click", "#special_title4", function(){
  ...
  const swiper_five = new Swiper('#five_swiper_container', {
    // Optional parameters
    direction: 'horizontal',
    loop: true,
    slidesPerView: 2,
  ...
  const swiper_six = new Swiper('#six_swiper_container', {
    // Optional parameters
    direction: 'horizontal',
    loop: true,
    slidesPerView: 2,
